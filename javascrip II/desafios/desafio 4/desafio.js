...
//REQUERIMIENTO 1
var opcion= document.getElementById("add1");
var opcion2= document.getElementById("btnAdd");
var bus = 
opcion.onclick = crearElementos;
opcion2.onclick = agregarExistentes;
...
function agregarExistentes() {
  ...
  if(document.s1.buscar.value != ""){
    //establecer funcion arrow
    let result = data => (e=>e.quote.includes(document.s1.buscar.value));
    console.log(result);
    //establecer funcion arrow
    result(e => {
      let titulo = document.createElement('h2');
