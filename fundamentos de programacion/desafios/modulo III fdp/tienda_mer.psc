...
SubProceso salidas(nombre_cliente,tipo_mer,cant_mer,precioini,precio_b,precio_t,fun_porc,porc)
	mostrar"-------FACTURA--------"
	mostrar"Nombre del cliente " nombre_cliente
	mostrar"Tipo de mermelada " tipo_mer "  " porc 
...
Algoritmo tienda_mer
	...
	salidas(nombre_cliente,tipo_mer,cant_mer,precioini,precio_b,precio_t,fun_porc,porc)
